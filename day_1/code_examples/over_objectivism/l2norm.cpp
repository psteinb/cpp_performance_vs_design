...
int main(int argc, char* argv[])
{
  ...
  std::cout << "flat		" << delta_flat/50  <<" s (l2norm: " << flat_l2norm << ", "<< memory_consumption_mbyte << " MB)\n";
  ...
  std::cout << "pixel		" << delta_pixel/50  <<" s (l2norm: " << pixel_l2norm << ", "<< memory_consumption_mbyte << " MB)\n";
