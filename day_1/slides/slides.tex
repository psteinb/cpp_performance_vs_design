...
\frametitle{\insertsectionhead{}: \insertsubsection{}}
\begin{figure}[htb]
\includegraphics<1>[height=0.4\textheight]{img/johnny_automatic_coffee_maker}
\includegraphics<2->[height=0.4\textheight]{img/johnny_automatic_coffee_maker_qm}
\\[2pt]\small
(source: \href{http://openclipart.org/detail/1551/coffee-maker-by-johnny_automatic}{openclipart.org})
\end{figure}
\begin{itemize}\large
