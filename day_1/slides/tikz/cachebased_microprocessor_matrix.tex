...
\path (l2unif.south) edge[thick,-] (memif.north);
\path let
\p1 = (l1d.west),
\p2 = (l2unif.east),
\p3 = (l1i.west),
...
\draw[-,thick] (l2unif_l1d_interf) -- (l1d.west);
...
\draw[thick,-] (l1d.north) |- (aboveof_l1d_north) -| (topright_limit) -- (junctn_ld_east);
...
\path (RAM_interf) edge[-,thick] (memif.west);
