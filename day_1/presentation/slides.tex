...
%       \begin{pyglist}[language=c++,numbers=left,style=emacs]
% void f(HugeMemoryObject by_value){
%   //... do something
% }

% int main(...){
%   while(true){
%     HugeMemoryObject temp;
%     f(temp);
%   }
% }
%       \end{pyglist}
...
%     \item \cpp{} offers great control and great possibilities for errors
%     \end{itemize}
%   \end{frame}
...
%     \item pay attention to what you write in performance critical sections of your code
%     \item compilers might detect and fix slow code (no guarantee!)
%     \item if in doubt, \alert{profile} (at best with different compilers)!
%     \end{itemize}
%   \end{frame}
