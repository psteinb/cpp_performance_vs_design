...
{
\begin{frame}<beamer>
\frametitle{Part \insertpartnumber{}: \insertpart{} }
...
\begin{columns}[c]
  ...
  \begin{column}{.6\textwidth}
    \large
    Programmers waste enormous amounts of time thinking about, or worrying about, the speed of noncritical parts of their programs, and these attempts at efficiency actually have a strong negative impact when debugging and maintenance are considered. We should forget about small efficiencies, say about $\unit[97]{\%}$ of the time: \textbf{premature optimization is the root of all evil}. \only<2->{\textit{Yet we should not pass up our opportunities in that critical $\unit[3]{\%}$.}}\\[12pt]
    \begin{raggedright}
...
\end{center}
\begin{figure}[htb]
\includegraphics[height=0.5\textheight]{tikz/move}\\[6pt]
...
\begin{frame}%[fragile]
  ...
  \begin{center}
    \huge
    Examples of performance problematic use of \cpp{}\\
  ...
  \item if in doubt, \alert{profile} and \alert{talk} to fellow developers/scientists!
  \end{itemize}
  \vfill
\end{frame}
...
\vfill
\begin{figure}[htb]
\includegraphics[height=0.5\textheight]{tikz/move}\\[6pt]\huge
MOVE!
\end{figure}
\vfill
\end{frame}
...
\begin{columns}[c]
  \begin{column}{.47\textwidth}
    \begin{block}{A Process}
      \begin{figure}[htb]
        \includegraphics[height=0.7\textheight]{tikz/process}
      \end{figure}
    \end{block}
  \end{column}
\pause
    \begin{column}{.47\textwidth}
      ...
      \begin{figure}[htb]
        \includegraphics[height=0.7\textheight]{tikz/thread}
      \end{figure}
    \end{block}
    \end{column}
  \end{columns}
...
\begin{columns}[c]
  \begin{column}{.47\textwidth}
    \begin{block}{Shared-Memory Parallelisation}
      \begin{figure}[htb]
        \includegraphics[height=0.7\textheight]{tikz/smp}
      \end{figure}
    \end{block}
  \end{column}
  \pause
    \begin{column}{.47\textwidth}
      ...
      \begin{figure}[htb]
        \includegraphics[height=0.7\textheight]{tikz/mpi}
      \end{figure}
    \end{block}
    \end{column}
  \end{columns}
...
\begin{frame}[fragile]
  ...
  \begin{columns}[c]
    ...
    \begin{column}{.67\textwidth}
      \begin{block}{Implicit Parallelisation}<1->
...
parallel_suite::parallel_for(data, 
                             expensive_operation());
        \end{pyglist}
      \end{block}
    \end{column}
...
\begin{block}{What to expect?}
  \begin{itemize}
  \item given a fixed working set size, parallelisation (multi-threading) can reduce time-to-solution
  \item having an application with $p$ fraction of code (or fraction of working set) that can be parallelised and $s$ that cannot
  \item application speedup:\\
    ...
    \begin{center}
      Amdahl's Law, \cite{AmdahlsArgument}
    \end{center}
    \normalsize
...
\begin{columns}
  ...
  \begin{column}{.35\textwidth}
    \begin{figure}[htb]
      \includegraphics[width=\textwidth]{tikz/move}
    \end{figure}
  \end{column}
